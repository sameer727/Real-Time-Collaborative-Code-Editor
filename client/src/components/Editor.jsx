        ...
        const requireCfg = () => {
          ...
          require(['vs/editor/editor.main'], () => {
            ...
            if (window.YMonaco) {
              ...
              s2.src = 'https://cdn.jsdelivr.net/npm/y-monaco@1.0.0/dist/y-monaco.js';
              s2.crossOrigin = 'anonymous';
              s2.onload = onYMonacoReady;
              s2.onerror = () => { console.error('Failed to load y-monaco from CDN'); };
