...
1
  ...
  await page1.waitForFunction((rid) => !!(window.__rtcEditors && window.__rtcEditors[rid]), roomId);
  await page2.waitForFunction((rid) => !!(window.__rtcEditors && window.__rtcEditors[rid]), roomId);
